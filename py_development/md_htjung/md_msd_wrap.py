...
parser = argparse.ArgumentParser(
	...
	description='calculate mean square displacement of molecules with wrapped trajectory')
## args
...
def process_init():
	...
	return 1 # initial mode number = 1
# print process bar
