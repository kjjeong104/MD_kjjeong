...
##part 2: micelle diameter (using only oxygens)
  maxdist=0
  for x in oxys:
    for y in oxys:
      if x!=y:
        dist=distdet(totcrd[x][3:6],totcrd[y][3:6],0,box)
        if dist>maxdist:
          maxdist=dist
