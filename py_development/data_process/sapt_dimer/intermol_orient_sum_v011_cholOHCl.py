...
SAPTnodrude cholOHCl:4, SAPTnodrude cholOHuO:5\n"))
outstrlist=['saptpol_cholOHCl','saptpol_cholOHuO','fpmd_cholOHCl','fpmd_cholOHuO','oldsapt_cholOHCl','oldsapt_cholOHuO']
inputstr=['Chol_Cl_','Urea_Chol_','Chol_Cl_','Chol_Urea_','Chol_Cl_','Urea_Chol_']
textlist_sub_dist1=['NCldist','chHuNdist','NCldist','chHuNdist','NCldist','chHuNdist']
textlist_sub_ang1=['OHClang','OHuOang','OHClang','OHuOang','OHClang','OHuOang']
...
#NCl SAPTnodrude 1 22/ chHuN SAPTnodrude : 29 (2,3) 
mother_list_dist=np.array([ [0,28],[32,1],[15,21],[20,22],[0,21],[28,1] ]) #
mother_list_dist_alter=np.array([ [0,28],[32,2],[15,21],[20,24],[0,21],[28,2] ])
#OHCl SAPTpol: 20 21 29, OHuO SAPTpol: 32 33 1/
# OHCl FPMD:20 21 22/OHuO FPMD: 20 21 24
#OHCl SAPTnodrude : 20 21 22/OHuO SAPTnodrude : 28 29 1 
mother_list_angle=np.array([ [19,20,28],[31,32,0],[19,20,21],[19,20,23],[19,20,21],[27,28,0] ])
#NCCO : SAPT cholOHCl: 1 14 17 20 / SAPT cholOHuO: 13 26 29 32/ 
#FPMD cholOHCl:16 13 17 20 / FPMD cholOHuO 16 13 17 20
#NCCO SAPTnodrude cholOHCl : 1 14 17 20/ SAPT nodrude cholOHuO : 9 22 25 28
mother_list_dih1=np.array([ [0,13,16,19],[12,25,28,31],[15,12,16,19],[15,12,16,19],[0,13,16,19],[8,21,24,27] ])
...
for i in range(ndimers):
  ...
  traj=md.load_xyz(xyzin,top="sample_Chol_Cl.pdb")
  #if intcode==2:
  ...
  outfile.write("{:4} {:8.3f} {} {:8.3f} {:8.3f} {:8.3f} dim# NCCOdih {} {} mainpair_dist\n".\
  #format(i,main_dih,tg_class,sub_dist1,sub_ang1,sub_dih2,text_sub_dist1,text_sub_ang1,text_sub_dih2))
  format(i,main_dih,tg_class,sub_dist1,sub_ang1,maindist,text_sub_dist1,text_sub_ang1))
