...
def main():
  ...
  arange=input("angle range in cosines, to judge as hydrogen bond? ex) -1.0 -0.8\n ")
  ...
  h0ht,h0htcount,ct=numpy.zeros(int(nstep/2),dtype=float),numpy.zeros(int(nstep/2)),numpy.zeros(int(nstep/2),dtype=float) # autocorrelation function array
  have=0
