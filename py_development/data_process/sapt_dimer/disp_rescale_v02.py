...
def main():
  ...
  x=numpy.arange(len(ff_ecomp_disp))
  #function to opt new coef
  #target for new fitting : monomer (newdisp_mon), atom index (start from 0: newdisp_atom)
  def newdisp(x,c6,c8,c10): #new disp calculation for 1 snapshot. C12 discarded.
  ...
  new_coeffs,cov=curve_fit(newdisp,x,ff_ecomp_disp,p0=guessc6810,method='lm')
