...
# v031 : can unwrap periodicity.  
#can choose to keep drude particles. output file can be pdb format.
...
def main():
  ...
  if save_drude=='n':
    traj=traj.atom_slice([atom.index for atom in topology.atoms if ('D' not in atom.name) ])
