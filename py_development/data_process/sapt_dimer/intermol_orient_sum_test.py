...
ndimers=1000
outfile= open("sumtest_intgeom_"+outstr+".dat",'w')
...
for i in range(999,ndimers):
  ...
  print("maindih crd",crd[0][list_dih1[0]])
  if sub_distc1>sub_distc2:
    print("subdist1 crd",crd[0][list_distc2[0]])
  else:
    print("subdist1 crd",crd[0][list_distc1[0]])
  print("subang1 crd",crd[0][list_angle[0]])
  #print("subdih2 crd",crd[0][list_dih2[0]])
