...
C
        OPEN(4,FILE='pdl2cm-ds.inp',STATUS='UNKNOWN')
...
C     
        OPEN(9,FILE='pdl2cm-ds.out',STATUS='UNKNOWN')
C
...
1191    FORMAT(2X,'DIAMETER RATIO',4X,E18.8)
...
C
        IF(OLDDEN .EQ. 1.0D0) THEN
         OPEN(1,FILE='pdl2cm-ds.ic',STATUS='UNKNOWN')
         DO I = 1, MESH
...
C        CALCULATE DENSITY (MAIN EQUATION)
          ...
          FP=-QP*PSI(I)+C1PB-C1PA+C1EL11(I)+C1EL12(I)
          FM=-QM*PSI(I)+C1MB-C1MA+C1EL21(I)+C1EL22(I)
C
          FPP(I) = FP
          FMM(I) = FM
C
...
C
        ...
        IF(MOD(NITER,50).EQ.0)THEN
         WRITE(9,121)NITER,SUMP,SUMM,SUMT
         WRITE(6,121)NITER,SUMP,SUMM,SUMT
        ENDIF
121     FORMAT(2X,'NITER',I10,4X,'SUMP',4X,E18.8,4X,
     C        'SUMM',4X,E18.8,4X,'SUMT',4X,E18.8)
C
       IF(MOD(NITER,500) .EQ. 0)THEN
        OPEN(1, FILE = 'pdl2cm-ds.fc',STATUS='UNKNOWN')
        DO I = 1, MESH
         WRITE(1,117)R(I),DENP(I),DENM(I),DENBARP(I),DENBARM(I)
        ENDDO
        CLOSE(1,STATUS = 'KEEP')
       ENDIF
C
...
C
       OPEN(1, FILE = 'pdl2cm.out', STATUS = 'UNKNOWN') 
       DO I=1,MESH
        IF(DENP(I).GT.0.0D0) THEN
...
C     C              DENBARM(I),C1EL1P(I),C1EL1M(I)
        ...
        WRITE(9,122)RI,DENPI,DENMI,PSI,DENP(I),DENM(I),DENBARP(I),
     C              DENBARM(I),C1EL1P(I),C1EL1M(I)
       ENDDO
