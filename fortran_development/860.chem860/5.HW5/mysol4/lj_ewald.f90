...
! Problem 5 - check the results for the derivatives.
  delta = .04d0  ! variable used to test finite difference.  It is currently too big.
  ...
  write(*,'(a,f12.6)')' the analytical force is ',frwald(12,j)
  write(*,*)' These should be the same '
	write(*,'(a,f12.6)')' LR ewald pot : ', vk
