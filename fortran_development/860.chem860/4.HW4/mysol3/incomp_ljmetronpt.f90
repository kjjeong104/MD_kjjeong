...
!  --------------------------------------------------------------------------
  ...
  real(kind=8)               :: dens_avg,vavg            !average calculated density and potential
...
!-----------------------------------------------------------------------------------
  ...
  real(kind=8)               :: eno,r2i,r6i,rc3it,rc9it
  real(kind=8)               :: xr,r2
  ...
  enddo
         rc9it=(1.d0/rcut)**9
         rc3it=(1.d0/rcut)**3
  eno = eno + (rc9it*(8.d0/9.d0)*pi*npart*density)-(rc3it*(8.d0/3.d0)*pi*npart*density) !LRC included
