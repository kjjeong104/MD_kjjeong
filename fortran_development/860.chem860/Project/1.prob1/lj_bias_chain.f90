  program lj_bias_chain
  use lj_bias_chain_mod
  implicit none
!  --------------------------------------------------------------------------
  integer                    :: i,j                      !counter variables
  integer                    :: irun,iflag    !number of steps used used in Monte Carlo 
...
! ----------------------------------------------------------------
  open(16,file='lj_bias_chain.dat')
